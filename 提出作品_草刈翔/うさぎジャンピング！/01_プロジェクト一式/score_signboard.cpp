...
// コンストラクタ
//=============================================================================
CScoreSignBoard::CScoreSignBoard(int nPriority) : CScene3D(nPriority)
{
...
// デストラクタ
//=============================================================================
CScoreSignBoard::~CScoreSignBoard()
{
...
// 初期化処理
//=============================================================================
HRESULT CScoreSignBoard::Init(D3DXVECTOR3 pos, D3DXVECTOR3 size, D3DCOLOR col)
{
	// 変数の初期化
	m_pos = pos;
	m_size = size;
...
// 終了処理
//=============================================================================
void CScoreSignBoard::Uninit(void)
{
	//ナンバーの破棄
	for (int nCntScore = 0; nCntScore < MAX_SCORE_BOARD_DIGIT; nCntScore++)
	{
...
// 更新処理
//=============================================================================
void CScoreSignBoard::Update(void)
{
...
// 描画処理
//=============================================================================
void CScoreSignBoard::Draw(void)
{
	for (int nCntScore = 0; nCntScore < MAX_SCORE_BOARD_DIGIT; nCntScore++)
	{
		// ヌルチェック
...
// 生成処理
//=============================================================================
CScoreSignBoard *CScoreSignBoard::Create(D3DXVECTOR3 pos, D3DXVECTOR3 size, D3DCOLOR col)
{
	// インスタンスの生成
	CScoreSignBoard *pScoreSignBoard = NULL;

	// ヌルチェック
	if (pScoreSignBoard == NULL)
	{
		pScoreSignBoard = new CScoreSignBoard;
		if (pScoreSignBoard != NULL)
		{
			// 初期化処理
			pScoreSignBoard->Init(pos, size, col);
		}
	}
	return pScoreSignBoard;
}

//=============================================================================
// 位置設定処理
//=============================================================================
void CScoreSignBoard::SetPos(D3DXVECTOR3 pos)
{
	m_pos = pos;
}