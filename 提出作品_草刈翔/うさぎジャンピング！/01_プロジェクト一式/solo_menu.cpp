...
#define SOLO_MENU_DIFFICULTY_POS_X	(1000.0f)	// 難易度選択の位置X
#define SOLO_MENU_DIFFICULTY_POS_Y	(260.0f)	// 難易度選択の位置Y
#define SOLO_MENU_DIFFICULTY_SIZE_X	(440.0f)	// 難易度選択のサイズX
#define SOLO_MENU_DIFFICULTY_SIZE_Y	(200.0f)	// 難易度選択のサイズY
...
void CSoloMenu::Update(void)
{
	...
	{
		// CPUのつよさ(吹き出し)
		m_apUi[4] = CUi::Create(D3DXVECTOR3(SOLO_MENU_DIFFICULTY_POS_X, SOLO_MENU_DIFFICULTY_POS_Y, 0.0f),
			D3DXVECTOR3(SOLO_MENU_DIFFICULTY_SIZE_X, SOLO_MENU_DIFFICULTY_SIZE_Y, 0.0f),
			PRIORITY_UI, CUi::UI_TYPE_SOLO_MENU_DIFFICULTY_00);
		// CPUのつよさ(文字)
		m_apUi[5] = CUi::Create(D3DXVECTOR3(SOLO_MENU_DIFFICULTY_POS_X + 37.0f, SOLO_MENU_DIFFICULTY_POS_Y + 40.0f, 0.0f),
